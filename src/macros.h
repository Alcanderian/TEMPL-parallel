...
#ifndef PARALLEL_MACROS_H
#define PARALLEL_MACROS_H
 ...
 * @endcode
 */
#define INT_WRAP(x, x0, xF) (((x) >= (x0) && (x) <= (xF)) ? (x) : ((x) < (x0)) ? ((x) - (int)(((x) - (x0) + 1) / ((xF) - (x0) + 1) - 1) *  ((xF) - (x0) + 1)) : ((x) - (int)(((x) - (xF) - 1) / ((xF) - (x0) + 1) + 1) * ((xF) - (x0) + 1)))
 ...
 * @endcode
 */
#define REAL_WRAP(x, x0, xF) (((x) >= (x0) && (x) <= (xF)) ? (x) : ((x) < (x0))  ? ((x) - (int)(((x) - (x0)) / ((xF) - (x0)) - 1) * ((xF) - (x0))) : ((x) - (int)(((x) - (xF)) / ((xF) - (x0)) + 1) * ((xF) - (x0))))
 ...
 * @endcode
 */
#define NEXT_POWER_OF_2(x) pow(2, ceil(log((RFLOAT) x) / log(2.0) - 1e-6))
