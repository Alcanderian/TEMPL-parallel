...
#ifndef PARALLEL_ARGS_H
#define PARALLEL_ARGS_H
...
public:
    ...
    void addOption(std::string option, std::string usage, std::string default_value = "NULL", bool hidden = false);

    /** Get the value from the command line, and adds option to the list if it did not yet exist */
    std::string
    getOption(std::string option, std::string usage, std::string default_value = "NULL", bool hidden = false);

    /** Returns true if option was given and false if not, and adds option to the list if it did not yet exist */
    bool checkOption(std::string option, std::string usage, std::string default_value = "false", bool hidden = false);

    /** Write the stored command line to outstream */
    void writeCommandLine(std::ostream &out);
    ...
    /** Write one line of the usage */
    void writeUsageOneLine(int i, std::ostream &out);

    /** Write one section of the usage */
    void writeUsageOneSection(int section, std::ostream &out);

    /** Write the usage for all options */
    void writeUsage(std::ostream &out);
};

#endif //PARALLEL_ARGS_H
